...
public class NoticeDeleteFlight extends JFrame {
	...
	public NoticeDeleteFlight() {
		...
		JLabel lblDeleteThisTicket = new JLabel("delete this flight information");
		...
		JButton btnCofirmDelFlight = new JButton("Yes");
		btnCofirmDelFlight.setFont(new Font("Lucida Grande", Font.BOLD, 13));
		btnCofirmDelFlight.setBounds(295, 149, 117, 46);
		panel.add(btnCofirmDelFlight);
	}
}
