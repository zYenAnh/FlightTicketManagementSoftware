...
public class NoticeDeleteEmployeeView extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					NoticeDeleteEmployeeView frame = new NoticeDeleteEmployeeView();
	 ...
	 * Create the frame.
	 */
	public NoticeDeleteEmployeeView() {
		...
		JLabel lblDeleteThisTicket = new JLabel("delete this employee information");
		...
		JButton btnCofirmDelEmployee = new JButton("Yes");
		btnCofirmDelEmployee.setFont(new Font("Lucida Grande", Font.BOLD, 13));
		btnCofirmDelEmployee.setBounds(295, 149, 117, 46);
		panel.add(btnCofirmDelEmployee);
	}
}
